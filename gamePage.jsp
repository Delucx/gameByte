    ...
    <div class="contentContainer">
        ...
        <div class="rightSide">
            <div class="commentReview">
                ...
                <form id="commentForm" action="CreatePost" method="POST">
                    ...
                    <div class="recommendCont">
                        ...
                        <div class="radio">
                            ...
                            <label for="yes" class="thumbsUp">
                                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-hand-thumbs-up-fill colorUp" viewBox="0 0 16 16">
